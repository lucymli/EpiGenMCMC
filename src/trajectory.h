...
public:
    ...
    void set_traj(double, int);
    void set_traj(double, int, int);
    void set_traj2(double, int);
    void set_state(double, int);
    double get_traj(int) const;
